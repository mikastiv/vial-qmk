...
LSFT_T(KC_TAB),  KC_A,    KC_S,    KC_E,   LSFT_T(KC_T),KC_G,                          KC_Y, RSFT_T(KC_N), KC_I,     KC_O,    KC_H,  KC_QUOT,
        KC_LCTL, KC_Z,    KC_X,    KC_C,     KC_V,      KC_B,     KC_MUTE,   KC_MUTE,  KC_P,    KC_M,      KC_COMM,  KC_DOT,  KC_SLSH,  KC_BSLS,
